...
public class JwtTokenUtils {
    ...
    public static String generateToken(String username, Set<String> roles, Long duration, String issuer)
       ...
       // long currenTimeInSecs = currentTimeInSecs();
      ...
      //  claimsBuilder.issuedAt(currenTimeInSecs);
       // claimsBuilder.expiresAt(currenTimeInSecs + duration);
